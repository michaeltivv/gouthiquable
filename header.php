		...
		<header class="header" role="banner" id="main-header">
				<div id="inner-header" class="wrap cf">
					...
					<p id="logo" class="h1">
						...
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="nofollow" style="width:300px;margin:0 auto;display:block;"><img src="<?php echo esc_url( get_theme_mod( 'huxley_logo' ) ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" /></a></p>
